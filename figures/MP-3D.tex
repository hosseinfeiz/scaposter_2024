...
\put(62,33){$v_R$}
\end{overpic}}}};
\node[inner sep=0pt] (1) at (-4,0.5){\includegraphics[width=.1\textwidth]{figures/p1.jpg}};
\node[inner sep=0pt] (2) at (-4,-1.1) {\includegraphics[width=.1\textwidth]{figures/p2.jpg}};
