...
\put(75,36){\fontsize{35}{18}\selectfont $\mathrm{L}_{\text{GMM}} + \, \mathrm{L}_{\text{Vposer}}$}
...
\color{black}
\put(18,35){\rotatebox{-90}{\fontsize{22}{16}\selectfont $\mathbf{bboxes}$}}
\put(36.3,32){\rotatebox{-90}{\fontsize{22}{16}\selectfont $\mathbf{J}_\text{2D}$}}
